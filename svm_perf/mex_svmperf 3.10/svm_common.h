...
#else
MODEL *read_model(const mxArray *);
void   write_model(mxArray *plhs[], MODEL *);
#endif
...
#else
void read_documents(const mxArray *[], DOC ***, double **, long *, long *);
void parse_mxData(int , const mxArray *, const mxArray *, double *doc_label, WORD *words);
#endif
