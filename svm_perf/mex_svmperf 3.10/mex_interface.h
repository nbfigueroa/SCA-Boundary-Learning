...
void my_fprintf(FILE *, const char *, ...); // to MEXify fprintf(stdout,...)
void my_free(void *ptr); // to avoid freeing NULL
void *my_malloc(size_t size);
void *my_realloc(void *ptr, size_t size); // to avoid reallocating from a NULL pointer
//
